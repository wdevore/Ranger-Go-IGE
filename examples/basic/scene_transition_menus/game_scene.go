...
func newGameScene(name string, world api.IWorld, fontRenderer api.ITextureRenderer) (api.INode, error) {
	o := new(gameMenu)
	o.Initialize(name)
...
func (s *gameMenu) build(world api.IWorld, fontRenderer api.ITextureRenderer) error {
	s.Node.Build(world)
	...
	newGameLayer("Game Layer", world, fontRenderer, s)
