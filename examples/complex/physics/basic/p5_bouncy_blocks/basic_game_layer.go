...
type gameLayer struct {
	...
	quadBoxPhyComp  *quadBoxPhysicsComponent
...
func (g *gameLayer) addGround() error {
	...
	g.groundLineNode.SetRotation(maths.DegreeToRadians * 5.0)
...
func (g *gameLayer) addQuadBox() error {
