...
// BitmapFont9x9Node2 is a font node
type BitmapFont9x9Node2 struct {
	nodes.Node
...
// NewBitmapFont9x9Node2 constructs a bitmap font node
func NewBitmapFont9x9Node2(name, textureAtlas string, textureMan api.ITextureManager, world api.IWorld, parent api.INode) (api.INode, error) {
	o := new(BitmapFont9x9Node2)
	o.Initialize(name)
	o.SetParent(parent)
	parent.AddChild(o)
...
func (d *BitmapFont9x9Node2) Build(world api.IWorld) error {
	d.Node.Build(world)
...
// Populate ...
func (d *BitmapFont9x9Node2) Populate() {
...
func (d *BitmapFont9x9Node2) SetText(text string) {
	d.text = text
...
// SetColor ...
func (d *BitmapFont9x9Node2) SetColor(colr []float32) {
	d.color = colr
}

// Draw renders shape
func (d *BitmapFont9x9Node2) Draw(model api.IMatrix4) {
